...
DateofString& DateofString::getpp() {
...
void DateofString::to_string() {

	ostringstream oss, os, ozz, oz;
	oss << len_c;
	cout << "string: " << pp << endl << "lenth of string: " << oss.str() << endl;
	os << day; cout << "day: " << os.str() << endl;
	ozz << mounth; cout << "mounth: " << ozz.str() << endl;
	oz << year; cout << "year: " << oz.str() << endl;
}
