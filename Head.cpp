...
Prstr& Prstr::operator=(const Prstr& other) {
	...
	try {
		...
		if (other.pp == nullptr && !other.pp) throw "Operator = didn't work ";
...
Prstr Prstr::operator+(const char* other) {
	...
	try {
		...
		if (other == nullptr && !other) throw "Operator + didn't work ";
...
bool operator==(const Prstr& pp, const char* other) {
	...
	try {
		...
		if (other == nullptr && !other && pp.pp == nullptr && !pp.pp) throw "Operator == didn't work ";
...
bool operator==(const Prstr& pp, const Prstr& other) {
	...
	try {
		...
		if (other.pp == nullptr && !other.pp && pp.pp == nullptr && !pp.pp) throw "Operator == didn't work ";
